...
# Awesome Marp · Claude 主题

###### “米白底 + 珊瑚橙强调,衬线标题 + 无衬线正文”

二次开发: 亦瑾
基于 [Awesome-Marp](https://github.com/favourhong/Awesome-Marp) 衍生的 Claude 网页风格主题示例
本示例展示 `am_claude` 主题在各类版面下的呈现效果
...
- Awesome Marp 的主题色（6 种基础 + 2 套自定义），可在 YAML 区切换 Theme，如 `theme: am_claude`：

| 深色      | 绿色       | 红色     | 蓝色      | 棕色       | 紫色 |  | 厦大配色 | Claude配色 |
|---------|----------|--------|---------|----------|----| --|----------|----------|
| `am_dark` | `am_green` | `am_red` | `am_blue` | `am_brown` |`am_purple`||`am_xmu`|**`am_claude`**|
...
<!-- _class: cover_c -->
<!-- _paginate: "" -->
<!-- _footer: Make work meaningful. -->
<!-- _header: "" -->
<!-- 如需在 header 显示你的 logo, 替换上面的 _header 为: ![](path/to/your_logo.svg) -->




# <!-- fit -->Awesome Marp · Claude 主题
...
<!-- _footer: "" -->
<!-- _header: "" -->
<!-- 若已自备 Claude 风格 logo, 替换为: -->
<!-- _footer: ![](../themes/assets/claude_logo_name.svg) -->
<!-- _header: ![](../themes/assets/claude_logo.svg) -->
...
<!-- 若已自备 Claude 风格 logo, 替换 _header 为: 目录<br>CONTENTS<br>![](../themes/assets/claude_logo.svg) -->
<!-- _class: toc_b -->
<!-- _footer: "" -->
<!-- _paginate: "" -->
...
<!-- _class: navbar -->
<!-- _header: \ ***@am_claude*** *关于模板* *封面页* *目录页* *分栏与分列* *引用盒子* **导航栏** *基础知识*-->
